...
const button = document.querySelectorAll(".total_buton");
...
if (button > 0){
    ...
    //   element.addEventListener("click", selectRoom)
    // button.click(selectRoom())
}
    ...
    return `
        <div class="room">
            ...
            <div class="container-detail">
                ...
                <button class="btn-adquire total_buton" id="select_element" onclick="selectRoom()">
